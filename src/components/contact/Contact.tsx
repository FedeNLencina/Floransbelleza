...
export default function Contact() {
  return (
    <div className="container-fluid contactContainer">
      <section className="topSection animate__animated animate__fadeInLeft">
      ...
      <div className="container-fluid contactFirstSection">
        ...
        <div className="row contactFirstSectionRow d-flex justify-content-center p-lg-5">
          <div className="col-lg-6 col-12 instagramFeedContainer">
            <InstagramFeed isContactPath={true} />
          </div>
          <div className="col-lg-6 col-12 mapContactContainer d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInLeft">
            <iframe
